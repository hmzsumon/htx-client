...
const AuthFooter = () => {
	...
	return (
		<div className='z-50 footer-bg w-full fixed bottom-0 bg-green-600 grid grid-cols-3 px-4 py-1 rounded-t-2xl font-bold'>
			{/*Start Upper Section */}
			...
			<div className=' relative  w-full gap-2 '>
				<Link href='/promotion'>
					<div className='absolute bottom-14 left-1/2 transform -translate-x-1/2'>
						<div className='relative z-20  rounded-full  flex justify-center items-center text-lg font-bold'>
							<div className='bg-htx-blue z-20 w-10 h-10 rounded-full flex justify-center items-center cursor-pointer absolute  '>
				...
				<div className='  text-center my-1'>
					<Link href='/promotion'>
						<p className='text-xs  text-white mt-7'>Promotion</p>
					</Link>
				</div>
			</div>
