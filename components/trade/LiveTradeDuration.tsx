			...
			<div className='flex items-center justify-around p-1 text-xs list-none text-blue-gray-300 bg-blue-gray-900 md:text-md bg-slate-300'>
				<li
					className={`cursor-pointer ${
						tradeDuration === '5m' ? 'text-green-500 font-bold' : ''
					}`}
				...
				<li
					className={`cursor-pointer ${
						tradeDuration === '15m' ? 'text-green-500 font-bold' : ''
					}`}
				...
				<li
					className={`
								cursor-pointer ${tradeDuration === '1h' ? 'text-green-500 font-bold' : ''}
							`}
					onClick={() => handleSetTime('1h')}
				>
					1h
				</li>
				<li
					className={`
								cursor-pointer ${tradeDuration === '2h' ? 'text-green-500 font-bold' : ''}
							`}
					onClick={() => handleSetTime('2h')}
				>
					2h
				</li>
				<li
...
export default LiveTradeDuration;
